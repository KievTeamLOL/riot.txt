...
<div class="inmainbk">
<div class="somethinglikemenu"><ul class="THIS_IS_MEEEENU"><li><a href="">Europe West</a></li><li><a href="index2.php">North America</a></li><li><a href="a_boat.html">Something more freaky</a></li></ul><div class="clear_shi_"> </div></div>
...
<tr>
<td><?PHP  $query = mysqli_query($db_euw, "SELECT value FROM total WHERE id_total=105"); $result = mysqli_fetch_array($query); echo $result[0];?></td>
<td><img width="128px" src="http://ddragon.leagueoflegends.com/cdn/5.2.2/img/champion/<?PHP  echo str_replace(" ","",$result[0]); ?>.png"></td>
</tr>
<tr>
<td><?PHP  $query = mysqli_query($db_euw, "SELECT value FROM total WHERE id_total=106"); $result = mysqli_fetch_array($query); echo $result[0];?></td>
<td><img width="128px" src="http://ddragon.leagueoflegends.com/cdn/5.2.2/img/champion/<?PHP  echo str_replace(" ","",$result[0]); ?>.png"></td>
</tr>
<tr>
<td><?PHP  $query = mysqli_query($db_euw, "SELECT value FROM total WHERE id_total=107"); $result = mysqli_fetch_array($query); echo $result[0];?></td>
<td><img width="128px" src="http://ddragon.leagueoflegends.com/cdn/5.2.2/img/champion/<?PHP echo $result[0]; ?>.png"></td>
</tr>
</table>
</div>
...
<table class="midornottobemid cmps">
<tr>
<td><?PHP  $query = mysqli_query($db_euw, "SELECT value FROM total WHERE id_total=88"); $result = mysqli_fetch_array($query); echo $result[0];?></td>
<td><img width="128px" src="http://ddragon.leagueoflegends.com/cdn/5.2.2/img/champion/<?PHP  echo str_replace(" ","",$result[0]); ?>.png"></td>
</tr>
<tr>
<td><?PHP  $query = mysqli_query($db_euw, "SELECT value FROM total WHERE id_total=89"); $result = mysqli_fetch_array($query); echo $result[0];?></td>
<td><img width="128px" src="http://ddragon.leagueoflegends.com/cdn/5.2.2/img/champion/<?PHP  echo str_replace(" ","",$result[0]); ?>.png"></td>
</tr>
<tr>
<td><?PHP  $query = mysqli_query($db_euw, "SELECT value FROM total WHERE id_total=90"); $result = mysqli_fetch_array($query); echo $result[0];?></td>
<td><img width="128px" src="http://ddragon.leagueoflegends.com/cdn/5.2.2/img/champion/<?PHP  echo str_replace(" ","",$result[0]); ?>.png"></td>
</tr>
<tr>
<td><?PHP  $query = mysqli_query($db_euw, "SELECT value FROM total WHERE id_total=91"); $result = mysqli_fetch_array($query); echo $result[0];?></td>
<td><img width="128px" src="http://ddragon.leagueoflegends.com/cdn/5.2.2/img/champion/<?PHP  echo str_replace(" ","",$result[0]); ?>.png"></td>
</tr>
<tr>
<td><?PHP  $query = mysqli_query($db_euw, "SELECT value FROM total WHERE id_total=92"); $result = mysqli_fetch_array($query); echo $result[0];?></td>
<td><img width="128px" src="http://ddragon.leagueoflegends.com/cdn/5.2.2/img/champion/<?PHP  echo str_replace(" ","",$result[0]); ?>.png"></td>
</tr>
<tr>
<td><?PHP  $query = mysqli_query($db_euw, "SELECT value FROM total WHERE id_total=93"); $result = mysqli_fetch_array($query); echo $result[0];?></td>
<td><img width="128px" src="http://ddragon.leagueoflegends.com/cdn/5.2.2/img/champion/<?PHP  echo str_replace(" ","",$result[0]); ?>.png"></td>
</tr>
<tr>
<td><?PHP  $query = mysqli_query($db_euw, "SELECT value FROM total WHERE id_total=94"); $result = mysqli_fetch_array($query); echo $result[0];?></td>
<td><img width="128px" src="http://ddragon.leagueoflegends.com/cdn/5.2.2/img/champion/<?PHP  echo str_replace(" ","",$result[0]); ?>.png"></td>
</tr>
<tr>
...
<td><img width="128px" src="http://ddragon.leagueoflegends.com/cdn/5.2.2/img/champion/<?PHP  echo ucfirst(strtolower(str_replace(" ","",$result[0]))); ?>.png"></td>
</tr>
</table>
</div>
...
$query = mysqli_query($db_euw, "SELECT value FROM total WHERE id_total=111"); $result = mysqli_fetch_array($query);?></td>
<td><img src="http://ddragon.leagueoflegends.com/cdn/5.2.2/img/item/<?PHP  echo $result[0]; ?>.png"></td>
</tr>
<tr>
<td><?PHP  $query = mysqli_query($db_euw, "SELECT value FROM total WHERE id_total=5"); $result = mysqli_fetch_array($query); echo $result[0];
$query = mysqli_query($db_euw, "SELECT value FROM total WHERE id_total=112"); $result = mysqli_fetch_array($query);?></td>
<td><img src="http://ddragon.leagueoflegends.com/cdn/5.2.2/img/item/<?PHP  echo $result[0]; ?>.png"></td>
</tr>
<tr>
<td><?PHP  $query = mysqli_query($db_euw, "SELECT value FROM total WHERE id_total=6"); $result = mysqli_fetch_array($query); echo $result[0];
$query = mysqli_query($db_euw, "SELECT value FROM total WHERE id_total=113"); $result = mysqli_fetch_array($query);?></td>
<td><img src="http://ddragon.leagueoflegends.com/cdn/5.2.2/img/item/<?PHP  echo $result[0]; ?>.png"></td>
</tr>
</table>
</div>
...
<td><?PHP  $query = mysqli_query($db_euw, "SELECT value FROM total WHERE id_total=21"); $result = mysqli_fetch_array($query); echo number_format($result[0], 0, ',', ' ');?></td>
</tr>
<tr>
<td>Total dragon kills</td>
<td><img src="images/STATS_INFORNATIONIC/oother/DragonSquare.png"></td>
<td><?PHP  $query = mysqli_query($db_euw, "SELECT value FROM total WHERE id_total=23"); $result = mysqli_fetch_array($query); echo number_format($result[0], 0, ',', ' ');?></td>
</tr>
<tr>
<td>Total turret kills</td>
<td><img src="images/STATS_INFORNATIONIC/oother/GolemSquare.png"></td>
<td><?PHP  $query = mysqli_query($db_euw, "SELECT value FROM total WHERE id_total=22"); $result = mysqli_fetch_array($query); echo number_format($result[0], 0, ',', ' ');?></td>
</tr>
</table>
</div>
...
<td><?PHP  $query = mysqli_query($db_euw, "SELECT value FROM total WHERE id_total=24"); $result = mysqli_fetch_array($query); echo number_format($result[0], 2, ',', ' ').' seconds <br> '.number_format($result[0]/60, 2, ',', ' ') .' minutes <br> '.number_format($result[0]/3600, 2, ',', ' ') .' hours<br> '.number_format($result[0]/(3600*24), 2, ',', ' ') .' days <br>'.number_format($result[0]/(3600*24*7), 2, ',', ' ').' weeks<br>'.number_format($result[0]/(3600*24*7*4), 2, ',', ' ').' months<br>'.number_format($result[0]/(3600*24*7*4*12), 2, ',', ' ').' years.';?></td>
</tr>
<tr>
<td>The longest game duration</td>
<td><img src="images/STATS_INFORNATIONIC/oother/clock_longest.png"></td>
<td><?PHP  $query = mysqli_query($db_euw, "SELECT value FROM total WHERE id_total=25"); $result = mysqli_fetch_array($query); echo number_format($result[0], 2, ',', ' ').' seconds <br> '.number_format($result[0]/60, 2, ',', ' ') .' minutes <br> '.number_format($result[0]/3600, 2, ',', ' ') .' hours.';?></td>
</tr>
<tr>
<td>The fastest game duration</td>
<td><img src="images/STATS_INFORNATIONIC/oother/clock_fastest.png"></td>
<td><?PHP  $query = mysqli_query($db_euw, "SELECT value FROM total WHERE id_total=26"); $result = mysqli_fetch_array($query); echo number_format($result[0], 2, ',', ' ').' seconds <br> '.number_format($result[0]/60, 2, ',', ' ') .' minutes <br> '.number_format($result[0]/3600, 2, ',', ' ') .' hours.';?></td>
</tr>
<tr>
<td>Average duration of games</td>
<td><img src="images/STATS_INFORNATIONIC/oother/clock_average.png"></td>
<td><?PHP  $query = mysqli_query($db_euw, "SELECT value FROM total WHERE id_total=27"); $result = mysqli_fetch_array($query); echo number_format($result[0], 2, ',', ' ').' seconds <br> '.number_format($result[0]/60, 2, ',', ' ') .' minutes <br> '.number_format($result[0]/3600, 2, ',', ' ') .' hours.';?></td>
</tr>
</table>
</div>
...
<td><?PHP  $query = mysqli_query($db_euw, "SELECT value FROM total WHERE id_total=31"); $result = mysqli_fetch_array($query); echo number_format($result[0], 0, ',', ' ');?></td>
</tr>
<tr>
<td>Total physical damage taken</td>
<td><img src="images/STATS_INFORNATIONIC/oother/phys_taken.png"></td>
<td><?PHP  $query = mysqli_query($db_euw, "SELECT value FROM total WHERE id_total=32"); $result = mysqli_fetch_array($query); echo number_format($result[0], 0, ',', ' ');?></td>
</tr>
<tr>
<td colspan="2">Maximal per game physical damage taken by summoner</td>
<td><?PHP  $query = mysqli_query($db_euw, "SELECT value FROM total WHERE id_total=33"); $result = mysqli_fetch_array($query); echo number_format($result[0], 0, ',', ' ');?></td>
</tr>
<tr>
<td colspan="2">Minimal per game physical damage taken by summoner</td>
<td><?PHP  $query = mysqli_query($db_euw, "SELECT value FROM total WHERE id_total=34"); $result = mysqli_fetch_array($query); echo number_format($result[0], 0, ',', ' ');?></td>
</tr>
<tr>
